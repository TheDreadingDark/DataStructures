...
void LinkedListTester :: testListBasics()
{
    ...
    numbers.add(0);
    cout << numbers.getFront()->getData() << " Is is at the front of the list ans should be 9" << endl;
...
void LinkedListTester :: testListWithData()
{
    ...
    LinkedList<CrimeData> crimes = FileController :: readDataToList("/Users/awoo9855/Documents/Swift Projects/DataStructures/DataStructures/Data/crime.csv");
    listTimer.stopTimer();
