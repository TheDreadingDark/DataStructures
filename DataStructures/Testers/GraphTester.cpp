...
void GraphTester :: compareTraversals()
{
    ...
    puzzle.breadthFirstTraversal(puzzle, 12); //12 Megan Smith name //28 Will I Am name
    
    cout << endl << "Depth Traversal" << endl;
    puzzle.depthFirstTraversal(puzzle, 8); //33 Will I Am quote //8 Megan Smith quote
}
